...
from smooths import sigma1, sigma2, sigmam, s
...
def run_sim(sim_state, s_kernel, b_kernel, B1, D1, B2, D2, alpha):
...
def get_next_state(HEIGHT,WIDTH,R_A,FACTOR,MASK_RATIO,ALPHA,B1,B2,D1,D2,DT,ORGANISM_COUNT):
    ...
    while True:
        yield sim_state
        sim_state_diff = run_sim(sim_state, s_kernel, b_kernel, B1, D1, B2, D2, ALPHA)
